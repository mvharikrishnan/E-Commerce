...
class PrivacyNoteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    <strong>Privacy Policy</strong> <p>
                  Harikrishnan Mv built the Artify app as
                  ...
                  Artify unless otherwise defined in this Privacy Policy.
                  ...
                  this page.
                </p> <p>This policy is effective as of 2023-01-06</p> <p><strong>Contact Us</strong></p> <p>
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Html(data: htmlData,style: {"strong":Style()},)
            ],
          ),
        ),
      ),
